...
declare global {
  ...
  const formatFileSize: typeof import('../../utils/fileValidation').formatFileSize
  ...
  const getFileExtension: typeof import('../../utils/fileValidation').getFileExtension
  ...
  const validateFile: typeof import('../../utils/fileValidation').validateFile
  const validationRules: typeof import('../../utils/fileValidation').validationRules
...
declare global {
  ...
  // @ts-ignore
  export type { FileItem, ComparisonResult } from '../../stores/files'
  import('../../stores/files')
}
...
declare module 'vue' {
  interface ComponentCustomProperties {
    ...
    readonly formatFileSize: UnwrapRef<typeof import('../../utils/fileValidation')['formatFileSize']>
    ...
    readonly getFileExtension: UnwrapRef<typeof import('../../utils/fileValidation')['getFileExtension']>
    ...
    readonly validateFile: UnwrapRef<typeof import('../../utils/fileValidation')['validateFile']>
    readonly validationRules: UnwrapRef<typeof import('../../utils/fileValidation')['validationRules']>
