...
export { validationRules, validateFile, formatFileSize, getFileExtension, ValidationResult } from '../utils/fileValidation';
export { useFilesStore, FileItem, ComparisonResult } from '../stores/files';
