...
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderClass, ssrIncludeBooleanAttr, ssrInterpolate, ssrRenderStyle, ssrRenderList } from 'vue/server-renderer';
import { u as useFilesStore, f as formatFileSize, v as validateFile } from './fileValidation-DRWMU_zZ.mjs';
...
const useFileUpload = () => {
  ...
  const handleFileDrop = (event) => {
    ...
    const droppedFiles = Array.from(((_a = event.dataTransfer) == null ? void 0 : _a.files) || []);
...
//# sourceMappingURL=index-DVRhgMUC.mjs.map
