import { defineComponent, computed, withAsyncContext, mergeProps, unref, ref, useSSRContext } from 'vue';
...
import { u as useFilesStore, f as formatFileSize } from './fileValidation-DRWMU_zZ.mjs';
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const addedCount = computed(() => {
      var _a, _b, _c;
      return ((_c = (_b = (_a = comparisonResult.value) == null ? void 0 : _a.data) == null ? void 0 : _b.added) == null ? void 0 : _c.length) || 0;
    });
    const removedCount = computed(() => {
      var _a, _b, _c;
      return ((_c = (_b = (_a = comparisonResult.value) == null ? void 0 : _a.data) == null ? void 0 : _b.removed) == null ? void 0 : _c.length) || 0;
    });
    const changedCount = computed(() => {
      var _a, _b, _c;
      return ((_c = (_b = (_a = comparisonResult.value) == null ? void 0 : _a.data) == null ? void 0 : _b.changed) == null ? void 0 : _c.length) || 0;
    });
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const addedItems = computed(() => {
      var _a, _b;
      return ((_b = (_a = comparisonResult.value) == null ? void 0 : _a.data) == null ? void 0 : _b.added) || [];
    });
    const removedItems = computed(() => {
      var _a, _b;
      return ((_b = (_a = comparisonResult.value) == null ? void 0 : _a.data) == null ? void 0 : _b.removed) || [];
    });
    const normalizeChangedItem = (item) => {
      var _a, _b, _c, _d, _e, _f, _g, _h, _i, _j, _k, _l, _m, _n, _o, _p, _q;
      if (!item || typeof item !== "object") return { key: null, changes: [], before: item, after: item };
      const key = (_e = (_d = (_c = (_b = (_a = item.key) != null ? _a : item.id) != null ? _b : item.ID) != null ? _c : item.code) != null ? _d : item.sku) != null ? _e : null;
      const changes = Array.isArray(item.changes) ? item.changes : Array.isArray(item.diff) ? item.diff : [];
      const before = (_k = (_j = (_i = (_h = (_g = (_f = item.before) != null ? _f : item.rowA) != null ? _g : item.a) != null ? _h : item.original) != null ? _i : item.from) != null ? _j : item.old) != null ? _k : null;
      const after = (_q = (_p = (_o = (_n = (_m = (_l = item.after) != null ? _l : item.rowB) != null ? _m : item.b) != null ? _n : item.modified) != null ? _o : item.to) != null ? _p : item.new) != null ? _q : null;
      return { ...item, key, changes, before, after };
    };
    const changedItems = computed(() => {
      var _a, _b;
      const raw = ((_b = (_a = comparisonResult.value) == null ? void 0 : _a.data) == null ? void 0 : _b.changed) || [];
...
//# sourceMappingURL=results-Cbphxx3f.mjs.map
